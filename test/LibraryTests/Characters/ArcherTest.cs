...
public class ArcherTest
{
    ...
    public void TestAddItem()
    {
        ...
        Assert.That(archer.GetItemList().Contains(sword));
    }
    ...
    public void TestRemoveItem()
    {
        ...
        Assert.That(archer.GetItemList().Contains(new Helmet())is false);
    }
    ...
    public void TestStartItems()
    {
        Archer archer = new Archer("Legolas");
        Bow bow = new Bow();
        Assert.That(archer.GetItemList().Contains(bow));
        Helmet helmet = new Helmet();
        Assert.That(archer.GetItemList().Contains(helmet));
